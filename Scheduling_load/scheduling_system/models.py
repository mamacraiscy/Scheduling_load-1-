...
#     room = models.ForeignKey(Room, on_delete=models.CASCADE)  # Linking to the Room model
#     day = models.CharField(max_length=10)  # Day of the week (e.g., 'Monday')
#     start_time = models.TimeField()  # Start time of the room booking
#     end_time = models.TimeField()    # End time of the room booking

#     class Meta:
#         db_table = 'room_schedule'

#     def __str__(self):
#         return f"{self.room} - {self.day} from {self.start_time} to {self.end_time}"
...
class ProgramSchedule(models.Model):
    ...
    db_tble = 'scheduling_system_programschedule'
...
# # New Schedule Model
# class ProgramSchedule(models.Model):
#     # This would be your main schedule model
#     instructor = models.ForeignKey(InstructorData, on_delete=models.CASCADE)
#     course = models.ForeignKey(InstructorCourse, on_delete=models.CASCADE)
